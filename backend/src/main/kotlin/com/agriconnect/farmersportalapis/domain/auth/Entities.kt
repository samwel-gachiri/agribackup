...
class UserProfile(
        ...
        @Column(unique = true, nullable = true) var email: String?,
        @Column(name = "password_hash", nullable = false) @JsonIgnore var passwordHash: String,
        @Column(name = "full_name", nullable = false) var fullName: String,
        @Column(name = "phone_number") var phoneNumber: String? = null,
        @JsonIgnore @Column(name = "is_active") var isActive: Boolean = true,
...
data class PasswordResetToken(
        ...
        @ManyToOne @JoinColumn(name = "user_id", nullable = false) val user: UserProfile,
        @Column(nullable = false) val expiryDate: LocalDateTime
) {
